...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	_base2.default.debug = 1;

	on($('#open'), 'click', function (e) {
	    _base2.default.view.openUrl('./music.html', 1);
	});

	on($('#open-baidu'), 'click', function (e) {
	    _base2.default.view.openUrl('https://www.baidu.com');
	});

	on($('#sn'), 'click', function (e) {
	    _base2.default.device.getSN(function (sn) {
	        return console.log(sn);
	    });
	});

	on($('#sn'), 'click', function (e) {
	    _base2.default.ui.toast('This is toast msg.');
	});

	// assign
	// HybridJS.invokeWeb('dom.setPageTitle', JSON.stringify({title: 'test'}))
	_base2.default.assign('dom.setPageTitle', function (params) {
	    document.title = (typeof params === 'undefined' ? 'undefined' : _typeof(params)) == 'object' ? params.title : params;
	});

	// HybridJS.invokeWeb('dom.getNodeText', JSON.stringify({req_sn: 'xx', id: '#off-listen-mback'}))
	_base2.default.assign('dom.getNodeText', function (params) {
