...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _music = __webpack_require__(3);
	...
	_music2.default.debug = 1;

	on($('#api-play'), 'submit', function (e) {
	    e.preventDefault();
	    _music2.default.music.play($('#id').value, $('#type').value, $('#name').value, $('#position').value);
	});

	_music2.default.on('music.stateChange', function onStateChange(data) {
